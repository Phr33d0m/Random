...
//#HDD info 
$harddrive = explode(' ', preg_replace('/\s\s+/', ' ', exec('df /dev/sda1'))); 
...
<html> 
    ...
    <body> 
        ...
        bandwidth used (m)<small></small><span><?=$vnstat[8].$vnstat[9].$vnstat[10].$vnstat[11];?></small></small></span> <!-- Monthly bandwidth usage --> 
